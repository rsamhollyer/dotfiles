 ...
 */
static char *font = "DankMono Nerd Font:pixelsize=16:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
	"Space Mono Nerd Font:pixelsize=16:antialias=true:autohint=true",
	"CascadiaCode:pixelsize=16:antialias=true:autohint=true",
};
